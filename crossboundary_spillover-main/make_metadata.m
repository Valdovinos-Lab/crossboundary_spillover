function r = make_metadata(data, e, mu_p, mu_a, c, b, u_ns, u_s, w, beta, G, g, phi, tau, epsilon)
...
assertP ( isequal(size(u_ns),[plant_qty,1]) );
assertP ( isequal(size(u_s),[plant_qty,1]) );
