...
######### date last modified: 1-14-2026 #######
###### create plant figure #######

### figure only now has plant species that share pollinators across soil types at least one meadow 
...
p2 <- plot_plant_panel(plant_means, "Q", "Pollination Quality", "B. Pollination Quality (Q)")
p3 <- plot_plant_panel(plant_means, "Seeds", "Total Seeds", "C. Seeds Produced")
p4 <- plot_plant_panel(plant_means, "D", "Effective Density", "D. Effective Density (D)")
...
ggsave("figure_4_plants.pdf", fig_plant, width = 15, height = 12, dpi = 600)
